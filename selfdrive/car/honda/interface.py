...
class CarInterface(object):
  ...
  def update(self, c):
    ...
    ret.steerStockTorque = self.CS.steer_stock_torque
    ret.steerStockTorqueRequest = self.CS.steer_stock_torque_request
    ...
    ret.steerParameter5 = self.CS.steer_parameter5
    ret.steerParameter6 = self.CS.steer_parameter6
    ...
    ret.steeringStatus = self.CS.steer_status
    ret.steeringTorqueMotor = self.CS.steer_torque_motor
    ret.steeringControlActive = self.CS.steer_control_active
