...
class CarState(object):
  ...
  def update(self, cp, cp_cam):
    ...
    if True == True:
      projected_angle_steers = cp.vl["STEERING_SENSORS"]['STEER_ANGLE'] + self.angle_steers_rate * 0.8
      self.angle_steers = (79.0 * self.angle_steers + projected_angle_steers) / 80.0
    else:
